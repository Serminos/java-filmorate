...
CREATE TABLE IF NOT EXISTS friendship (
    ...
    CONSTRAINT friendship_user_fk FOREIGN KEY (from_user_id) REFERENCES users(user_id) ON DELETE CASCADE,
    CONSTRAINT friendship_user_fk_1 FOREIGN KEY (to_user_id) REFERENCES users(user_id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS film_user_like (
    film_id int8 NOT NULL,
    user_id int8 NOT NULL,
    CONSTRAINT film_user_like_film_fk FOREIGN KEY (film_id) REFERENCES film(film_id) ON DELETE CASCADE,
    CONSTRAINT film_user_like_user_fk FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS directors (
    director_id int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS film_director (
    ...
    CONSTRAINT film_director_film_fk FOREIGN KEY (film_id) REFERENCES film(film_id) ON DELETE CASCADE,
    CONSTRAINT film_director_director_fk FOREIGN KEY (director_id) REFERENCES directors(director_id) ON DELETE CASCADE
);
