drop table if exists directors, rating_mpa, film, film_director, users, genre, film_genre, friendship, film_user_like,
                     review, review_like cascade;
...
CREATE TABLE IF NOT EXISTS film_director (
	...
	CONSTRAINT film_director_film_fk FOREIGN KEY (film_id) REFERENCES film (film_id),
